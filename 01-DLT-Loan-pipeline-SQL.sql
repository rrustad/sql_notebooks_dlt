...
-- MAGIC
-- MAGIC **Your DLT Pipeline is ready!** Your pipeline was started using this notebook and is <a dbdemos-pipeline-id="dlt-loans" href="/#joblist/pipelines/0e66f2af-b3e8-481d-a5cd-cf1708e30cf3">available here</a>.
-- MAGIC
-- MAGIC <!-- Collect usage data (view). Remove it to disable collection. View README for more details.  -->
-- MAGIC <img width="1px" src="https://www.google-analytics.com/collect?v=1&gtm=GTM-NKQ8TT7&tid=UA-163989034-1&aip=1&t=event&ec=dbdemos&ea=VIEW&dp=%2F_dbdemos%2Fdata-engineering%2Fdlt-loans%2F01-DLT-Loan-pipeline-SQL&cid=5206439413157315&uid=1062554160422868">
...
-- MAGIC %md ## Next steps
-- MAGIC
-- MAGIC Your DLT pipeline is ready to be started. <a dbdemos-pipeline-id="dlt-loans" href="/#joblist/pipelines/0e66f2af-b3e8-481d-a5cd-cf1708e30cf3">Click here to access the pipeline</a> created for you using this notebook.
-- MAGIC
...
-- MAGIC
-- MAGIC <a href="/sql/dashboards/373b926d-f97f-4e86-92b9-38dc3cfbb5a8" target="_blank">Data Quality Dashboard example</a>
