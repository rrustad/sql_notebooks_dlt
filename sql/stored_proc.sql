...
CREATE OR REPLACE TABLE riley_sql_notebooks.total_loan_balances
...
CREATE OR REPLACE VIEW riley_sql_notebooks.new_loan_balances_by_cost_center
AS SELECT sum(balance) sum_balance, cost_center_code FROM riley_sql_notebooks.cleaned_new_txs
  GROUP BY cost_center_code;

CREATE OR REPLACE VIEW new_loan_balances_by_country
